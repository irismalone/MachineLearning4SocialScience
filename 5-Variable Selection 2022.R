...
####################
rm(list=ls(all=TRUE))
singhway = read.csv("/Users/irismalone/Dropbox/Courses/Machine Learning/R Code/5-Variable/singhway.csv")
singhway = read.csv("C:\\Downloads\\singhway.csv", header=T, sep=";")
